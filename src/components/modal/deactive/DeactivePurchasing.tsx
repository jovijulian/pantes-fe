...
import { alertToast, endpointUrl, endpointUrlv2, httpDelete, httpPatch } from "../../../../helpers";
...
const DeactivePurchasingModal: React.FC<DeactiveModalProps> = ({
    isOpen,
    onClose,
    loading = false,
    url,
...
export default DeactivePurchasingModal;
