...
interface EditGeneralManagerModalProps {
    isOpen: boolean;
    selectedId: number;
    onClose: () => void;
    onSuccess?: () => void;
...
const EditGeneralManagerModal: React.FC<EditGeneralManagerModalProps> = ({
    isOpen,
    selectedId,
    onClose,
    onSuccess,
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            try {
                ...
                toast.error(err?.response?.data?.message || "Gagal mengambil data akun general manager.");
                setError("Tidak dapat memuat data akun general manager.");
            } finally {
                setIsLoading(false);
            }
        };
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setError(error?.response?.data?.message || "Failed to change general manager account.");
        }
...
export default EditGeneralManagerModal;
