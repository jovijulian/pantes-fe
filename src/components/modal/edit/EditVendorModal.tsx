...
const EditVendorModal: React.FC<EditProps> = ({
    isOpen,
    selectedId,
    onClose,
    onSuccess,
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setError("");
            try {
                const response = await httpGet(endpointUrl(`master/vendor/${selectedId}`), true);
    ...
    const handleSubmit = async () => {
        ...
        try {
            await httpPost(endpointUrl(`master/vendor/${selectedId}/update`), payload, true);
            toast.success("Berhasil mengubah vendor!");
            setFormData({
                id: 0,
                code: "",
                name: "",
            ...
            setError(error?.response?.data?.message || "Gagal mengubah vendor");
        }
            ...
            <div className="no-scrollbar relative w-full max-w-[500px] overflow-y-auto rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-8">
                ...
                >
                     <div className="space-y-5 px-2 pb-3">
                        <div>
                            <Label htmlFor="name">Kode Vendor</Label>
                            <Input
                                type="text"
                                id="code"
                                name="code"
