...
interface EditAreaManagerModalProps {
    isOpen: boolean;
    selectedId: number;
    onClose: () => void;
    onSuccess?: () => void;
...
const EditAreaManagerModal: React.FC<EditAreaManagerModalProps> = ({
    isOpen,
    selectedId,
    onClose,
    onSuccess,
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            try {
                ...
                toast.error(err?.response?.data?.message || "Gagal mengambil data akun area manager.");
                setError("Tidak dapat memuat data akun area manager.");
            } finally {
                setIsLoading(false);
            }
        };
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setError(error?.response?.data?.message || "Failed to change area manager account.");
        }
...
export default EditAreaManagerModal;
