...
import EditModal from "@/components/modal/edit/EditCustomerCategoryModal";
        ...
        <div className="space-y-4">
            ...
            <div className="flex justify-end items-center">
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => router.push("/customer-categories/create")}
            ...
            <DeactiveModal
                ...
                url={`master/customer-category/${selectedData?.id}/deactive`}
