...
export default function PurchaseOrdersPage() {
    ...
    const getStatusBadge = (status: string) => {
        ...
        let label = "Unknown";
        switch (status) {
            case '1': color = 'warning'; label = 'New'; break;
            case '2': color = 'info'; label = 'Valid'; break;
            case '3': color = 'success'; label = 'Approved'; break;
            case '4': color = 'success'; label = 'PO'; break;
    ...
    const handleConfirmStatusChange = async () => {
        ...
        try {
            await httpPut(endpointUrlv2(`purchase/order/status/${selectedOrder.id}`), payload, true);
                ...
                cell: ({ row }: { row: any }) => {
                    ...
                    return (
                        <div className="flex items-center gap-2">
                            ...
                            {status === '3' && (
                                <button
                                    // onClick={() => ... } // Tambahkan aksi untuk 3 -> 4 jika ada
                                    title="Buat PO"
                                    disabled
                                    className="p-2 rounded-md bg-purple-100 text-purple-700 opacity-50 cursor-not-allowed"
                                >
