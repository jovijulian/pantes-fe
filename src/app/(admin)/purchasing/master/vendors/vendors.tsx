...
import EditModal from "@/components/modal/edit/EditVendorModal";
    ...
    const getData = async () => {
        ...
        try {
            const response = await httpGet(
                endpointUrl("master/vendor"), true, params
            );
        ...
        <div className="space-y-4">
            <div className="flex justify-end items-center">
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => router.push("/purchasing/master/vendors/create")}
            ...
            <DeactiveModal
                ...
                url={`master/vendor/${selectedData?.id}/deactive`}
                itemName={`${selectedData?.name} (${selectedData?.code})` || ""}
