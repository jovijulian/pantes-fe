...
import EditModal from "@/components/modal/edit/EditEmployeeModal";
        ...
        <div className="space-y-4">
            <div className="flex justify-end items-center">
                <div className="flex gap-2">
                    ...
                    />
                    <button
                        onClick={() => router.push("/purchasing/master/employees/create")}
            ...
            <DeactiveModal
                ...
                url={`master/employee/${selectedData?.id}/deactive`}
