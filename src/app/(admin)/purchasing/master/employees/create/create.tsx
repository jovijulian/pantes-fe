...
export default function CreateForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await httpPost(
                endpointUrlv2("/master/employee"),
                data,
                true,
            );
            toast.success("Karyawan berhasil ditambahkan!");
            router.push("/purchasing/master/employees");
        } catch (error: any) {
            toast.error(error?.response?.data?.errors?.type || "Gagal menambahkan karyawan.");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <ComponentCard title="Data Karyawan">
            ...
            <div>
                ...
                <div>
                    <label htmlFor="type" className="block font-medium mb-1 text-gray-700 dark:text-gray-300">
                        Nama Karyawan<span className="text-red-400 ml-1">*</span>
                    </label>
                    <Input
                        type="text"
                ...
                <div className="flex justify-end gap-2">
                    <button
                        onClick={() => router.push("/purchasing/master/employees")}
                        type="button"
