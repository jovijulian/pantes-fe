...
import EditModal from "@/components/modal/edit/EditBankModal";
        ...
        <div className="space-y-4">
            ...
            <div className="flex justify-end items-center">
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => router.push("/purchasing/master/banks/create")}
            ...
            <DeactiveModal
                ...
                url={`master/bank/${selectedData?.id}/deactive`}
                itemName={`${selectedData?.account_name} (${selectedData?.bank_name})` || ""}
