...
export default function LMNotReceivedReportPage() {
    ...
    const [reportData, setReportData] = useState<ILMNotReceived[] | null>(null);
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            let filename = `laporan_lm_belum_terima_${moment().format('DDMMYYYY')}.pdf`;
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                        ...
                        Laporan LM Belum Terima
                    </h1>
                    <p className="text-gray-500 text-sm mt-1">Laporan daftar pesanan LM yang belum diterima.</p>
                </div>
            </div>
