...
import EditAreaManagerModal from "@/components/modal/edit/EditAreaManagerModal";
        ...
        <div className="space-y-4">
            <div className="flex justify-end items-center">
                <div className="flex gap-2">
                    ...
                    />
                    <button
                        onClick={() => router.push("/admin-panel/general-manager/create")}
                        className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 flex items-center gap-2"
                    >
                        <span className="text-lg font-bold">+</span>
                        Tambahkan Akun General Manager
                    </button>
                </div>
            </div>
            ...
            <DeactiveModal
                ...
                url={`general-manager/${selectedData?.id}/deactive`}
