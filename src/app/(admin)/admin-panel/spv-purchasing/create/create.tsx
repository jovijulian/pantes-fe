...
export default function CreateForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success("SPV berhasil ditambahkan!");
            router.push("/admin-panel/spv-purchasing");
        } catch (error: any) {
            toast.error(error?.response?.data?.errors?.type || "Gagal menambahkan spv.");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <ComponentCard title="Data SPV Purchasing">
