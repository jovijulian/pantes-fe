...
export default function CreateForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success("Area manager berhasil ditambahkan!");
            router.push("/admin-panel/area-manager");
        } catch (error: any) {
            toast.error(error?.response?.data?.errors?.type || "Gagal menambahkan area manager.");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <ComponentCard title="Data Area Manager">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end gap-2">
                    <button
                        onClick={() => router.push("/admin-panel/area-manager")}
                        type="button"
